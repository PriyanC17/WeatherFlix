...
def get_weather_data(city, weather):
    weather_data = {
        'city': city,
        'wind': weather['target_wind_mph'],
        # 'temperature': predictions.get('target_temperature_celsius'),  # Removed as not using predictions
        'humidity': weather['target_humidity'],
        # 'date': datetime.utcnow() + timedelta(hours=5, minutes=30),  # Assuming predictions contain current date, removed
